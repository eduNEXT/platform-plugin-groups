...
"""
platform-plugin-groups documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-groups',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/platform-plugin-groups",
...
#
# html_title = 'platform-plugin-groups v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Where helpers for the a new groups definition are found!',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_groups'),
                os.path.join(root_path, 'platform_plugin_groups/migrations')])
