...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd platform_plugin_groups && ../manage.py makemessages -l en -v1 -d django
	cd platform_plugin_groups && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd platform_plugin_groups && ../manage.py compilemessages

detect_changed_source_translations:
	cd platform_plugin_groups && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd platform_plugin_groups && i18n_tool dummy
